...
@interface LFPoemBaseViewController ()

@end

@implementation LFPoemBaseViewController
...
- (void)addLeftButtonWithTitle:(NSString *)title {
    self.navigationItem.leftBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:title style:UIBarButtonItemStylePlain target:self action:@selector(backAction:)];
