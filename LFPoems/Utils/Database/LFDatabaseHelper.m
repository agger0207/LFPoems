...
#import "LFDatabaseHelper.h"
#import "LFCommonUtility.h"
#import "FMDatabaseQueue.h"
#import "NSString+LFCategory.h"

NSString * const LFDatabaseName = @"LFDefault.db";

@interface LFDatabaseHelper ()
...
@implementation LFDatabaseHelper

#pragma mark - Life Cycle

+ (instancetype)sharedInstance {
    static LFDatabaseHelper *_sharedInstance = nil;
