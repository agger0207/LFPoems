...
@class LFPageControllerView;

@protocol LFPageControllerViewDataSource<NSObject>
 ...
 *  @return controller实例
 */
- (UIViewController*)pageControllerView:(LFPageControllerView *)pageControllerView viewControllerForIndex:(NSUInteger)index;
 ...
 */
- (NSUInteger)preloadControllerCountInPageControllerView:(LFPageControllerView *)pageControllerView;
 ...
 */
- (NSUInteger)maxCachedControllerCountInpageControllerView:(LFPageControllerView *)pageControllerView;;
 ...
 */
@optional
- (UIView*)pageControllerView:(LFPageControllerView *)pageControllerView placeHolderViewForIndex:(NSUInteger)index;
@end

@protocol LFPageControllerViewDelegate<NSObject>
@optional
- (void)pageControllerViewDidScroll:(LFPageControllerView *)pageControllerView;
 ...
 */
@interface LFPageControllerView : UIScrollView
